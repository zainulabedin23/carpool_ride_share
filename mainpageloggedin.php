...
<html lang="en">
  <head>
    ...
    <script type='text/javascript' src='https://www.bing.com/api/maps/mapcontrol?key=AjyUnMwyZfHS0OUZcyOeKgZvbV0gg_nw0N0BbXPvQpUd-J6arKa7w_KEEXE3SCg8'></script>
              ...
              <div class="navbar-collapse collapse" id="navbarCollapse">
                  <ul class="nav navbar-nav">
                    ...
                    <li><a href="#">Help</a></li>
                      ...
                      <li><a href="notification.php">Request Recieved</a></li>
...
<!--Container-->
      ...
      <form action="verified.php"   method="post"  enctype="multipart/form-data">
...
    </form>z
      ...
      <form method="post" id="addtripform">
        ...
        <div class="modal" id="addtripModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              ...
              <div class="modal-footer">
                <input class="btn btn-primary" name="createTrip" type="submit" value="Create Trip" onclick="reloadPage()">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            </div>
          </div>
      </div>
     ...
     <footer>
      ...
      <script>
    function reloadPage() {
        // Reload the page when the "Create Trip" button is clicked
        location.reload();
    }
      </script>
