...
if ($result) {
    ...
    // Redirect to a welcome page or refresh the current page using JavaScript
    echo '<script>';
    echo 'alert("Successfully registered!");';
    echo 'window.location.href = "index.php";'; // Redirect to welcome.php or any other page you want
    echo '</script>';
    exit;
} else {
    echo '<div class="alert alert-danger">There was an error inserting the users details in the database!</div>';
