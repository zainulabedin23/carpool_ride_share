...
if(isset($_POST['show_reviews'])) {
    // SQL query to retrieve reviews for the logged-in driver
    $review_query = "SELECT users.first_name, review_table.user_rating, review_table.user_review, review_table.added_on FROM users
    INNER JOIN review_table ON users.user_id = review_table.user_id  where review_table.driver_id=".$user_id;

    $review_res=mysqli_query($link,$review_query);
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-condensed table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                        <?php $average = "SELECT AVG(user_rating) as avg FROM review_table WHERE driver_id=".$_SESSION['user_id'];
                          $average=mysqli_query($link, $average);
...
<form method="post" action="">
    <input type="submit" name="show_reviews" value="Reviews" class="btn btn-primary">
</form>
...
?>
        <table id="reviewTable" class="table table-bordered" class="table table-bordered">
            <thead>
                <tr>
